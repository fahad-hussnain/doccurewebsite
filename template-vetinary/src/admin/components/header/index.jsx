...
import logo_icon from "../../assets/images/logo-small.png";
                  ...
                  <div className="media">
                    ...
                    <div className="media-body">
                      <p className="noti-details">
                        <span className="noti-title">Dr. Ruby</span> Schedule{" "}
          ...
          <li className="nav-item dropdown has-arrow">
            <Dropdown className="user-dropdown">
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item href={`${config.publicPath}/admin/profile`}> My Profile</Dropdown.Item>
                <Dropdown.Item href={`${config.publicPath}/admin/settings`}>Settings</Dropdown.Item>
                <Dropdown.Item href={`${config.publicPath}/admin`}>Logout</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </li>
        </ul>
