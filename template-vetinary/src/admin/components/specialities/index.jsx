...
class Specialities extends Component{
	constructor(props) {
		...
		this.state = {
			show: null,
			data:[
                {id:'#SP001', image:IMG01, specialities:'Animal Genetics and Breeding'},
                {id:'#SP002', image:IMG02, specialities:'Veterinary Microbiology'},
                {id:'#SP003', image:IMG03, specialities:'Veterinary Pathology'},
                {id:'#SP004', image:IMG04, specialities:'Animal Nutrition'},
                {id:'#SP005', image:IMG05, specialities:'Veterinary Pathology'}
        ...
        return(
            ...
            <div className="page-wrapper">
			    <div className="content container-fluid">
					<div className="page-header">
						<div className="row">
							...
							<div className="col-sm-5 col">
								<a href="#0" className="btn btn-primary float-right mt-2" onClick={()=>this.handleShow('add')}>Add</a>
							</div>
						</div>
					</div>
				 ...
				 {/* Edit Modal */}
				 <Modal show={this.state.show === 'edit' || this.state.show === 'add'} onHide={this.handleClose} centered>
                        <Modal.Header closeButton>
                            <Modal.Title><h5 className="modal-title">{this.state.show == 'add' ? 'Add Specialities' :  'Edit Specialities'}</h5></Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
						<form>
				  ...
				  {/* Edit Modal */}
				   {/* Delete Modal */}
				 <Modal show={this.state.show === 'delete' || this.state.sho} onHide={this.handleClose} centered>
