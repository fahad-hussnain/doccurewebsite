                                        ...
                                        <div className="navbar">
                                            <div className="user-details mr-auto">
                                                <div className="float-left user-img">
                                                    <a className="avatar avatar-sm mr-2" href="#0" title="Charlene Reed">
                                        ...
                                        <div className="call-icons">
                                         <ul className="call-items"> 
                                                ...
                                                <OverlayTrigger overlay={<Tooltip id="tooltip1">Enable video</Tooltip>}>
                                                       ...
                                                       <a href="#0"> <i className="fas fa-video camera"></i></a>
                                                        </span>
                                                </OverlayTrigger>
                                                ...
                                                <OverlayTrigger overlay={<Tooltip id="tooltip2">Mute</Tooltip>}>
                                                        <span className="d-inline-block">
                                                       <a href="#0"> <i className="fa fa-microphone microphone"></i></a>
                                                        </span>
                                                </OverlayTrigger>
                                                </li>
                                                <li className="call-item">
                                                <OverlayTrigger overlay={<Tooltip id="tooltip2">Add User</Tooltip>}>
                                                        <span className="d-inline-block">
                                                       <a href="#0"> <i className="fa fa-user-plus"></i></a>
                                                        </span>
                                                </OverlayTrigger>
