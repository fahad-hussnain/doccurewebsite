                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Ruby Perrin <span>Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Linda Tobin <span>Neuro Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. John Gibbs <span>Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Olga Barlow <span>Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Darren Elder <span>Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td className="text-right">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Deborah Angel{" "}
                                        <span>Animal Genetics and Breeding</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td className="text-right">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Sofia Brient <span>Pediatric Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td className="text-right">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Marvin Campbell <span>Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td className="text-right">
                          ...
                          <table className="table table-hover table-center mb-0">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>14 Nov 2019</td>
                                <td>Veterinary Filling</td>
                                <td>
                                  <a href="#0">Veterinary-test.pdf</a>
                                </td>
                                <td>
                                  <h2 className="table-avatar">
                                    <Link
                              ...
                              <tr>
                                ...
                                <td>
                                  <h2 className="table-avatar">
                                    ...
                                    <Link to="/patient/doctor-profile">
                                      Dr. Deborah Angel <span>Animal Genetics and Breeding</span>
                                    </Link>
                                  </h2>
                                </td>
                                <td className="text-right">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Ruby Perrin <span>Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>$450</td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Sofia Brient
                                        <span>Pediatric Veterinary</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>$50</td>
