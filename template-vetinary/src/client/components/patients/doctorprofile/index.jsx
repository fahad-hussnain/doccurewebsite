								...
								<div className="doctor-widget">
									<div className="doc-info-left">
										...
										<div className="doc-info-cont">
											...
											<p className="doc-department"><img src={IMG02} className="img-fluid" alt="Speciality" />Veterinary</p>
											...
											<div className="clinic-services">
												<span>Animal Genetics and Breedings</span>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">American Veterinary Medical University</a>
																		<div>BDS</div>
													...
													<div className="experience-box">
														<ul className="experience-list">
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">Glowing Smiles Family Veterinary Clinic</a>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">Comfort Care Veterinary Clinic</a>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">Dream Smile Veterinary Practice</a>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		...
																		<h4 className="exp-title">The Veterinary Professional of The Year Award</h4>
																		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
																	</div>
																</div>
															</li>
												...
												<div className="row">
													...
													<div className="col-md-6">
														<div className="clinic-content">
															<h4 className="clinic-name"><a href="#0">Smile Cute Pediatric Veterinary Center</a></h4>
															<p className="doc-speciality">M.Sc. Veterinary</p>
															<div className="rating">
																<i className="fas fa-star filled"></i>
																<i className="fas fa-star filled"></i>
																<i className="fas fa-star filled"></i>
