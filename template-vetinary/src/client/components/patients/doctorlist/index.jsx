...
const data = [
    {
      ...
      lng: 150.6517938,
      icons: "default",
      profile_link: `${config.publicPath}/patient/doctor-profile`,
      total_review: "17",
      image: IMG01,
    },
    {
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-speciality">MDS - Veterinary Pathology</p>
                                <h5 className="doc-department"><img src={IMG10} className="img-fluid" alt="Speciality" />Pediatric Veterinary</h5>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <h5 className="doc-department"><img src={IMG11} className="img-fluid" alt="Speciality" />Geriatric Veterinary</h5>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-speciality">MBBS, MD - General Medicine, DNB - Animal Genetics and Breeding</p>
                                <p className="doc-department"><img src={IMG10} className="img-fluid" alt="Speciality" />Animal Genetics and Breeding</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-speciality">MBBS, MS - General Surgery, MCh - Pediatric Veterinary</p>
                                <p className="doc-department"><img src={IMG12} className="img-fluid" alt="Speciality" />Pediatric Veterinary</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-department"><img src={IMG13} className="img-fluid" alt="Speciality" />Pediatric Veterinary</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
