						...
						<div className="row justify-content-center">
							...
							<div className="col-12 mt-4 text-center">
								<ul className="policy-menu text-center">
									...
									<li><Link to="/doctor/doctor-dashboard">Doctors</Link></li>
									<li><Link to="/blog/blog-list">Blogs</Link></li>
							...
							<div className="row">
								<div className="col-md-12 col-lg-12 text-center">
									<div className="copyright-text">
										<p className="mb-0">&copy; 2020 <a href="#0" className="text-yellow"> Dentalcare</a> All Rights Reserved.</p>
									</div>
								</div>
							</div>
						</div>
