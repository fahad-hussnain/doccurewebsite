               ...
               <div className="row">
                    <div className="col-lg-12">
                        ...
                        <Slider {...settings}>
                            <div className="profile-widget">
                                ...
                                <div className="pro-content">
                                    ...
                                    <ul className="available-info">
                                        ...
                                        <li>
                                            <i className="fas fa-calendar-check"></i> Available on Fri, 20 Mar
                                        </li>
                                        <li>
                            ...
                            <div className="profile-widget">
                                ...
                                <div className="pro-content">
                                    ...
                                    <ul className="available-info">
                                        ...
                                        <li>
                                            <i className="fas fa-calendar-check"></i> Available on Mon, 22 Sep
                                        </li>
                                        <li>
                            ...
                            <div className="profile-widget">
                                ...
                                <div className="pro-content">
                                    ...
                                    <ul className="available-info">
                                        ...
                                        <li>
                                            <i className="fas fa-calendar-check"></i> Available on Fri, 22 Mar
                                        </li>
                                        <li>
                            ...
                            <div className="profile-widget">
                                ...
                                <div className="pro-content">
                                    ...
                                    <ul className="available-info">
                                        <li>
                                            <i className="fas fa-calendar-check"></i> Louisiana, USA
                                        </li>
                                        <li>
                                            <i className="fas fa-wallet"></i> Available on Fri, 22 Mar
                                        </li>
                                        <li>
                            ...
                            <div className="profile-widget">
                                ...
                                <div className="pro-content">
                                    <h3 className="title">
                                        <Link to="/patient/doctor-profile">Neomah Oliveira</Link> 
                                    </h3>
                            ...
                            <div className="profile-widget">
                                ...
                                <div className="pro-content">
                                    <h3 className="title">
                                        <Link to="/patient/doctor-profile">Jillisa Tremblay</Link> 
                                    </h3>
                                    ...
                                    <div className="rating">
                                        ...
                                        <i className="far fa-star"></i>
                                        <i className="far fa-star"></i>
                                        <span className="d-inline-block average-rating">(20)</span>
                                    </div>
                                    <ul className="available-info">
                                        <li>
                        ...
                        <div className="col-12 col-md-12 text-center pt-4">
                            <a href="#0" className="view-all">View All</a>
                        </div>
                    </div>
               </div>
            </div>
