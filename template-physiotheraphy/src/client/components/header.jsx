...
const Header = (props) => {
  ...
  return (
    <header className={`header ${pathnames.includes("home") || pathnames == "/template-physiotheraphy/" ? 'min-header' : ''}`}>
        ...
        <div className="container-fluid">
          <div className="row justify-content-between align-items-center">
            <div className="col-12 col-md-4">
              <div className="left">
                <a href="index.html" className="navbar-brand logo">
                  <img src={TopLogo} className="img-fluid" alt="Logo" />
                </a>									
              </div>
            </div>
            <div className="col-12 col-md-8">
              <div className="right">
                <ul>
                  <li><span><i className="fas fa-phone-alt" /> 090 98763456</span></li>
                  <li><span><i className="fas fa-map-marker-alt" /> 22, South Wales, New York</span></li>
                  <li><span><i className="fas fa-calendar-check" /> Mon - Fri : 09.00 AM to 05.00 PM</span></li>
                </ul>
              </div>
            </div>
          </div>
