                ...
                <div className="doctor-widget">
                    <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                            ...
                            <h5 className="doc-department"><img src={IMG_sp_02} className="img-fluid" alt="Speciality" />Accupuncture</h5>
                ...
                <div className="doctor-widget">
                    <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                            ...
                            <h5 className="doc-department"><img src={IMG_sp_03} className="img-fluid" alt="Speciality" />Accupuncture</h5>
                            <div className="rating">
                                <i className="fas fa-star filled"></i>
                                <i className="fas fa-star filled"></i>
                                <i className="fas fa-star filled"></i>
                ...
                <div className="doctor-widget">
                    <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                            ...
                            <p className="doc-department"><img src={IMG_sp_04} className="img-fluid" alt="Speciality" />Orthopaedics</p>
                            <div className="rating">
                                <i className="fas fa-star filled"></i>
                                <i className="fas fa-star filled"></i>
                                <i className="fas fa-star filled"></i>
                ...
                <div className="doctor-widget">
                    <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                            ...
                            <p className="doc-department"><img src={IMG_sp_05} className="img-fluid" alt="Speciality" /> Accupuncture</p>
                            <div className="rating">
                                <i className="fas fa-star filled"></i>
                                <i className="fas fa-star filled"></i>
                                <i className="fas fa-star filled"></i>
