                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Ruby Perrin <span>Accupuncture</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Linda Tobin <span>Orthopaedics</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. John Gibbs <span>Accupuncture</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Olga Barlow <span>Accupuncture</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Darren Elder <span>Accupuncture</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td className="text-right">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Sofia Brient <span>Accupuncture</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td className="text-right">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Dr. Marvin Campbell <span>Accupuncture</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td className="text-right">
                          ...
                          <table className="table table-hover table-center mb-0">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>14 Nov 2019</td>
                                <td>Accupuncture Filling</td>
                                <td>
                                  <a href="#0">Accupuncture-test.pdf</a>
                                </td>
                                <td>
                                  <h2 className="table-avatar">
                                    <Link
                              ...
                              <tr>
                                ...
                                <td>
                                  <h2 className="table-avatar">
                                    ...
                                    <Link to="/patient/doctor-profile">
                                      Dr. Deborah Angel <span>Orthopaedics</span>
                                    </Link>
                                  </h2>
                                </td>
                                <td className="text-right">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        Ruby Perrin <span>Accupuncture</span>
                                      </Link>
                                    </h2>
                                  </td>
                                  <td>$450</td>
