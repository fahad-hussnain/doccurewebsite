								...
								<div className="doctor-widget">
									<div className="doc-info-left">
										...
										<div className="doc-info-cont">
											...
											<p className="doc-department"><img src={IMG02} className="img-fluid" alt="Speciality" />Accupuncture</p>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">American Accupuncture Medical University</a>
																		<div>BDS</div>
													...
													<div className="experience-box">
														<ul className="experience-list">
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">Glowing Smiles Family Accupuncture Clinic</a>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">Comfort Care Accupuncture Clinic</a>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		<a href="#/" className="name">Dream Smile Accupuncture Practice</a>
															...
															<li>
																...
																<div className="experience-content">
																	<div className="timeline-content">
																		...
																		<h4 className="exp-title">The Accupuncture Professional of The Year Award</h4>
																		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
																	</div>
																</div>
															</li>
												...
												<div className="row">
													...
													<div className="col-md-6">
														<div className="clinic-content">
															<h4 className="clinic-name"><a href="#0">Smile Cute Accupuncture Center</a></h4>
															<p className="doc-speciality">M.Sc. Accupuncture</p>
															<div className="rating">
																<i className="fas fa-star filled"></i>
																<i className="fas fa-star filled"></i>
																<i className="fas fa-star filled"></i>
				   ...
				   <img src={IMG06} alt="Feature" />
											...
											<div className="location-list">
												<div className="row">
													...
													<div className="col-md-6">
														<div className="clinic-content">
															<h4 className="clinic-name"><a href="#0">The Family Optometristry Clinic</a></h4>
															<p className="doc-speciality">M.Sc. Accupuncture</p>
															<div className="rating">
																<i className="fas fa-star filled"></i>
																<i className="fas fa-star filled"></i>
							...
							<div className="call-wrapper">
								<div className="call-inner">
									...
									<div className="call-items">
										<a href="#0" className="btn call-item call-end" onClick={this.handleCloseModal} data-dismiss="modal" aria-label="Close">
										<Icon>call_end</Icon>
										</a>
