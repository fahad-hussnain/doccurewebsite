                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <h5 className="doc-department"><img src={IMG10} className="img-fluid" alt="Speciality" /> Accupuncture</h5>
               ...
               <a href="#0" onClick={() => this.setState({ isOpen: true, photoIndex: 3 })}>
                   <img src={img4} alt="Feature" />
                                ...
                                <div className="clinic-services">
                                    <span>Accupuncture Fillings</span>
                                    <span> Whitneing</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <h5 className="doc-department"><img src={IMG11} className="img-fluid" alt="Speciality" />Geriatric Accupuncture</h5>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-speciality">MBBS, MD - General Medicine, DNB - Orthopaedics</p>
                                <p className="doc-department"><img src={IMG10} className="img-fluid" alt="Speciality" />Orthopaedics</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-speciality">MBBS, MS - General Surgery, MCh - Accupuncture</p>
                                <p className="doc-department"><img src={IMG12} className="img-fluid" alt="Speciality" />Accupuncture</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-department"><img src={IMG13} className="img-fluid" alt="Speciality" />Accupuncture</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
