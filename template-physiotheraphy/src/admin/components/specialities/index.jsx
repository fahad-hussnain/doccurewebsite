...
class Specialities extends Component{
	constructor(props) {
		...
		this.state = {
			show: null,
			data:[
                {id:'#SP001', image:IMG01, specialities:'Electrotherapy'},
                {id:'#SP002', image:IMG02, specialities:'Accupuncture'},
                {id:'#SP003', image:IMG03, specialities:'Hydrotherapy'},
                {id:'#SP004', image:IMG04, specialities:'Hydrotherapys'},
                {id:'#SP005', image:IMG05, specialities:'Geriatric'}
