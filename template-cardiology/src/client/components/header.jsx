      ...
      <nav className="navbar navbar-expand-lg header-nav">
        ...
        <div className="main-menu-wrapper">
          ...
          <ul className="main-nav">
            ...
            <li className={`has-submenu ${url.includes("/patient") ? "active" : ""}`}>
              ...
              <ul className={`submenu`}>
                <li className={`has-submenu ${pathnames.includes("doctor") && !pathnames.includes("doctor-profile") && !pathnames.includes("search-doctor")  ? "active" : ""}`}>
                  <a href="#0">Doctors</a>
                  <ul className="submenu">
                    <li className={pathnames.includes("doctor-grid") && !pathnames.includes("search-doctor")  ? "active" : ""}>
                ...
                <li className={pathnames.includes("search-doctor") && !pathnames.includes("doctor-profile") ? "active" : ""}>
            ...
            <li className={`has-submenu ${url.includes("/pages") || pathnames.includes("/login") || pathnames.includes("/register") || pathnames.includes("/forgot-password") ? "active" : ""}`}>
              <a href="#0">
