...
<section className="clinics-section">
  <div className="shapes">
    <img src={Shape1} alt className="img-fluid shape-1" />
    <img src={Shape2} alt className="img-fluid shape-2" />
  </div>
  <div className="container">
    <div className="row">
      <div className="col-md-6">
    ...
    <div className="owl-carousel clinics owl-theme">
        ...
        <div className="clinic-item">
          <div className="clinics-card">
            <div className="clinics-img">
              <img src={clinic01} alt className="img-fluid" />
            </div>
      ...
      <div className="item">
        <div className="clinic-item">
          <div className="clinics-card">
            <div className="clinics-img">
              <img src={clinic02} alt className="img-fluid" />
            </div>
            <div className="clinics-info">
      ...
      <div className="item">
        <div className="clinic-item">
          <div className="clinics-card">
            <div className="clinics-img">
              <img src={clinic04} alt className="img-fluid" />
            </div>
            <div className="clinics-info">
      ...
      <div className="item">
        <div className="clinic-item">
          <div className="clinics-card">
            <div className="clinics-img">
              <img src={clinic03} alt className="img-fluid" />
            </div>
            <div className="clinics-info">
              <img src={Category5} alt className="img-fluid" />
      ...
      <div className="item">
        <div className="clinic-item">
          <div className="clinics-card">
            <div className="clinics-img">
              <img src={clinic05} alt className="img-fluid" />
            </div>
            <div className="clinics-info">
...
{/* /Clinic Section */}
  ...
  <div className="shapes">
    <img src={Shape3} alt className="img-fluid shape-3" />
    <img src={Shape4} alt className="img-fluid shape-4" />
  </div>
  <div className="container">
    <div className="row">
      <div className="col-md-6">
  ...
  <div className="container">
    ...
    <div className="owl-carousel our-doctors owl-theme">
      <div className="item">
        <div className="our-doctors-card">
          <div className="doctors-header">
            <a href="#"><img src={Doctor1} alt className="img-fluid" /></a>
      ...
      <div className="item">
        <div className="our-doctors-card">
          <div className="doctors-header">
            <a href="#"><img src={Doctor4} alt className="img-fluid" /></a>
            <div className="img-overlay">
              <span>$20 - $50</span>
            </div>
          </div>
      ...
      <div className="item">
        <div className="our-doctors-card">
          <div className="doctors-header">
            <a href="#"><img src={Doctor3} alt className="img-fluid" /></a>
            <div className="img-overlay">
              <span>$20 - $50</span>
            </div>
          </div>
      ...
      <div className="item">
        <div className="our-doctors-card">
          <div className="doctors-header">
            <a href="#"><img src={Doctor2} alt className="img-fluid" /></a>
            <div className="img-overlay">
              <span>$20 - $50</span>
            </div>
          </div>
  ...
  <div className="container">
    ...
    <div className="owl-carousel blogs owl-theme">
      <div className="item">
        <div className="our-blogs">
          <div className="blogs-img">
            <Link to="/blog/blog-details"><img src={blog1} alt className="img-fluid" /></Link>
            <div className="blogs-overlay d-flex">
              <img src={DoctorThumb01} alt className="img-fluid" />
      ...
      <div className="item">
        <div className="our-blogs">
          <div className="blogs-img">
            <Link to="/blog/blog-details"><img src={blog2} alt className="img-fluid" /></Link>
            <div className="blogs-overlay d-flex">
              <img src={DoctorThumb01} alt className="img-fluid" />
              <span className="blogs-writter">Dr. Ruby Perrin</span>
            </div>
      ...
      <div className="item">
        <div className="our-blogs">
          <div className="blogs-img">
            <Link to="/blog/blog-details"><img src={blog3} alt className="img-fluid" /></Link>
            <div className="blogs-overlay d-flex">
              <img src={DoctorThumb01} alt className="img-fluid" />
              <span className="blogs-writter">Dr. Ruby Perrin</span>
            </div>
      ...
      <div className="item">
        <div className="our-blogs">
          <div className="blogs-img">
            <Link to="/blog/blog-details"><img src={blog4} alt className="img-fluid" /></Link>
            <div className="blogs-overlay d-flex">
              <img src={DoctorThumb01} alt className="img-fluid" />
              <span className="blogs-writter">Dr. Ruby Perrin</span>
            </div>
