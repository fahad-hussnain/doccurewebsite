...
class PatientAccounts extends Component{
    constructor(props) {
        super(props);
        this.state = {
            show: null
          ...
          <div className="row">
            ...
            <div className="col-sm-6">
              <div className="text-right">
                <a title="Edit Profile" className="btn btn-primary btn-sm" onClick={() => this.handleShow("account_details")} data-toggle="modal"><i className="fas fa-pencil" /> Edit Details</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-md-12 text-center">
              <a href="#payment_request_modal" onClick={()=> this.handleShow("refund_request")} className="btn btn-primary request_btn" data-toggle="modal">Refund Request</a>
            </div>
          </div>
        </div>
      </div>
                            ...
                            <table className="table table-hover table-center mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span className="badge badge-pill bg-success-light">Paid</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span className="badge badge-pill bg-danger-light">Refunded</span></td>
                                        <td className="text-right">
                                            <div className="table-action">
                                                <a href="#" className="btn btn-sm bg-info-light">
                                                <i className="far fa-eye" /> View
        ...
        <div className="table-action">
          ...
          <a href="#" className="btn btn-sm bg-danger-light">
            <i className="fas fa-times" /> Cancel
                            ...
                            <Modal show={this.state.show=="account_details"} onHide={this.handleClose}>
                            ...
                            <Modal show={this.state.show=="refund_request"} onHide={this.handleClose}>
                                <Modal.Header closeButton>
