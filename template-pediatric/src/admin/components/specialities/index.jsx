...
class Specialities extends Component{
	constructor(props) {
		...
		this.state = {
			show: null,
			data:[
                {id:'#SP001', image:IMG01, specialities:'Low vision therapy'},
                {id:'#SP002', image:IMG02, specialities:'Neuro optometry'},
                {id:'#SP003', image:IMG03, specialities:'Pediatric optometry'},
                {id:'#SP004', image:IMG04, specialities:'Geriatric optometry'},
                {id:'#SP005', image:IMG05, specialities:'Pediatric optometry'}
			    ...
			    <div className="content container-fluid">
				 ...
				 <Modal show={this.state.show === 'edit' || this.state.show === 'add'} onHide={this.handleClose} centered>
                        <Modal.Header closeButton>
                            <Modal.Title><h5 className="modal-title">{ this.state.show === 'edit' ? 'Edit Specialities' : 'Add Specialities'}</h5></Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
						<form>
