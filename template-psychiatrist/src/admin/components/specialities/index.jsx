...
class Specialities extends Component{
	constructor(props) {
		...
		this.state = {
			show: null,
			data:[
                {id:'#SP001', image:IMG01, specialities:'Emotions'},
                {id:'#SP002', image:IMG02, specialities:'Psycho Spiritual Stress'},
                {id:'#SP003', image:IMG03, specialities:'Psycho Spiritual Stress'},
                {id:'#SP004', image:IMG04, specialities:'Geriatric Cognitive'},
                {id:'#SP005', image:IMG05, specialities:'Psycho Spiritual Stress'}
			    ...
			    <div className="content container-fluid">
					<div className="page-header">
						<div className="row">
							...
							<a href="#0" className="btn btn-primary float-right mt-2" onClick={()=>this.handleShow('add')}>
							 Add</a>
