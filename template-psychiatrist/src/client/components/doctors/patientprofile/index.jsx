                                  ...
                                  <tr>
                                    <td>
                                      <h2 className="table-avatar">
                                        ...
                                        <Link to="/patient/doctor-profile">
                                          Dr. Linda Tobin <span>Neuro optometry</span>
                                        </Link>
                                      </h2>
                                    </td>
                                    <td>
                                  ...
                                  <tr>
                                    <td>
                                      <h2 className="table-avatar">
                                        ...
                                        <Link to="/patient/doctor-profile">
                                          Dr. John Gibbs <span>Optometry</span>
                                        </Link>
                                      </h2>
                                    </td>
                                    <td>
                                  ...
                                  <tr>
                                    <td>
                                      <h2 className="table-avatar">
                                        ...
                                        <Link to="/patient/doctor-profile">
                                          Dr. Olga Barlow <span>Optometry</span>
                                        </Link>
                                      </h2>
                                    </td>
                                    <td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <h2 className="table-avatar">
                                        ...
                                        <Link to="/patient/doctor-profile">
                                          Dr. Ruby Perrin <span>Optometry</span>
                                        </Link>
                                      </h2>
                                    </td>
                                    <td className="text-right">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <h2 className="table-avatar">
                                        ...
                                        <Link to="/patient/doctor-profile">
                                          Dr. Darren Elder <span>Optometry</span>
                                        </Link>
                                      </h2>
                                    </td>
                                    <td className="text-right">
                                      <div className="table-action">
                                        ...
                                        >
                                          <i className="far fa-eye"></i> Delete
                                        </a>
                                      </div>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <h2 className="table-avatar">
                                        ...
                                        <Link to="/patient/doctor-profile">
                                          Dr. Sofia Brient <span>Pediatric optometry</span>
                                        </Link>
                                      </h2>
                                    </td>
                                    <td className="text-right">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <h2 className="table-avatar">
                                        ...
                                        <Link to="/patient/doctor-profile">
                                          Ruby Perrin <span>Optometry</span>
                                        </Link>
                                      </h2>
                                    </td>
                                    <td>$450</td>
          ...
          <Modal.Body>
            <div className="form-group">
              ...
              <input
                ...
                value="31-10-2019" onChange={(e) => console.log(e)}
              />
            </div>
            <div className="form-group">
              <label>Description ( Optional )</label>
              <textarea className="form-control" onChange={(e) => console.log(e)}></textarea>
            </div>
            <div className="form-group">
              <label>Upload File</label>
              <input type="file" className="form-control" onChange={(e) => console.log(e)} />
            </div>
